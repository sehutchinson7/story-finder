...
// counter = []
// const counter = Object.keys(data.nodes).map((key => data.nodes[key]
//   ))

//Object.keys(data.nodes).map((key) => data.nodes[key].ty

// class StoryInfo extends React.Component {
//   render() {
//     return null;
// <Link to={`/items/${this.props.id}`} className="icon-info">
